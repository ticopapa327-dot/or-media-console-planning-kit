...
For the runnable engineering skeleton, topology configuration, video routing, recording/media, teaching/remote/audio, quality/release, and local auth/RBAC increments, read `docs/dev/SPRINT_0_ENGINEERING_BOOTSTRAP.md`, `docs/dev/SPRINT_1_TOPOLOGY_CONFIGURATION.md`, `docs/dev/SPRINT_2_VIDEO_ROUTING.md`, `docs/dev/SPRINT_3_RECORDING_MEDIA.md`, `docs/dev/SPRINT_4_TEACHING_REMOTE_AUDIO.md`, `docs/dev/SPRINT_5_QUALITY_RELEASE.md`, and `docs/dev/SPRINT_6_AUTH_RBAC.md`. Use `docs/dev/RELEASE_READINESS_CHECKLIST.md` and `docs/dev/DEMO_SCRIPT.md` before a public demo, then run `pnpm install`, `pnpm test`, `pnpm build`, and `pnpm dev`.
