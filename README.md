...
进入开发阶段时，可阅读 `docs/dev/SPRINT_0_ENGINEERING_BOOTSTRAP.md`、`docs/dev/SPRINT_1_TOPOLOGY_CONFIGURATION.md`、`docs/dev/SPRINT_2_VIDEO_ROUTING.md` 和 `docs/dev/SPRINT_3_RECORDING_MEDIA.md`，并从以下命令启动：
...
For the runnable engineering skeleton, topology configuration, video routing, and recording/media increments, read `docs/dev/SPRINT_0_ENGINEERING_BOOTSTRAP.md`, `docs/dev/SPRINT_1_TOPOLOGY_CONFIGURATION.md`, `docs/dev/SPRINT_2_VIDEO_ROUTING.md`, and `docs/dev/SPRINT_3_RECORDING_MEDIA.md`, then run `pnpm install`, `pnpm test`, `pnpm build`, and `pnpm dev`.
