...
- `docs/dev/`：开发启动、工程实施记录、发布检查清单和演示脚本
...
- `docs/dev/` contains engineering bootstrap notes, sprint implementation notes, release checklist, and demo script.
...
For the runnable engineering skeleton, topology configuration, video routing, recording/media, teaching/remote/audio, quality/release, local auth/RBAC, and synthetic clinical-data increments, read `docs/dev/SPRINT_0_ENGINEERING_BOOTSTRAP.md`, `docs/dev/SPRINT_1_TOPOLOGY_CONFIGURATION.md`, `docs/dev/SPRINT_2_VIDEO_ROUTING.md`, `docs/dev/SPRINT_3_RECORDING_MEDIA.md`, `docs/dev/SPRINT_4_TEACHING_REMOTE_AUDIO.md`, `docs/dev/SPRINT_5_QUALITY_RELEASE.md`, `docs/dev/SPRINT_6_AUTH_RBAC.md`, and `docs/dev/SPRINT_7_SYNTHETIC_CLINICAL_DATA.md`. Use `docs/dev/RELEASE_READINESS_CHECKLIST.md` and `docs/dev/DEMO_SCRIPT.md` before a public demo, then run `pnpm install`, `pnpm test`, `pnpm build`, and `pnpm dev`.
